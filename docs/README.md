...
Project-level documents live at the repository root: [`README.md`](../README.md), [`SECURITY.md`](../SECURITY.md), [`CONTRIBUTING.md`](../CONTRIBUTING.md), [`LICENSE`](../LICENSE).

Maintainer-facing planning documents (PRD, technical spec, implementation plan, dependency policy, release checklist) live in [`internal/`](internal) — see [`internal/README.md`](internal/README.md).
